...
Various training programs and required_courses are offered by the Institute of Canadian Bankers and may be required by employers.
...
INSERT INTO programs (requirement_id, title, description, required_courses, grade_average, courses) VALUES (2, 'Ryerson University - Business Technology Management', 'Combine a love for technology, business and management and study at Canada’s largest school dedicated to business management and information and communication technologies (ICT).', 'High 70s, Mid 80s', ARRAY['English (ENG4U/EAE4U preferred)', 'Mathematics: One of Advanced Functions (MHF4U), Calculus and Vectors (MCV4U) or Mathematics of Data Management (MDM4U)','Grade 12 U Calculus and Vectors (MCV4U) is the preferred Mathematics course.'], '70%', 'Managerial Decision Making, Computer-Enabled Problem Solving, Accounting, Economics, Business Process Design, and Information Systems Security and Privacy');
...
INSERT INTO programs (requirement_id, title, description, required_courses, grade_average, courses) VALUES (2, 'University of Toronto - Computer Science (Major, Minor, Specialist)', 'Low 90s, High 80s', ' The Major program in Computer Science is designed to include a solid grounding in the essentials of Computer Science, followed by options that let you explore one or a few topics more deeply. You will also realize what areas you have not studied, and be ready to explore them if your interests change after completing the Major.', ARRAY['Calculus & Vectors (MCV4U)', 'English (ENG4U)'], 'Low 90s', 'Introduction to Computer Science, Enriched Introduction to the Theory of Computation, and Calculus');
